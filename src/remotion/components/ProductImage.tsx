...
/**
 * Draws one product photo into the 9:16 frame without ever distorting it
 * (spec §22-23).
 *
 ...
 * cover-scaled copy of the same photo and the sharp version is laid on top at
 * contain size, which keeps the whole product visible without letterbox bars.
 */
