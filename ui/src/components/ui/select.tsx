...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      data-size={size}
      className={cn(
        "border-input bg-background flex w-fit items-center justify-between gap-2 rounded-md border px-3 py-2 text-sm whitespace-nowrap shadow-xs outline-none data-[size=sm]:h-8 data-[size=default]:h-9 [&_svg:not([class*='size-'])]:size-4",
